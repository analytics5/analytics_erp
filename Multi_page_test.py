...
def update_datatable(Year, Country, Agency, City, Property_name):
    dropdowns= (Year, Country, Agency, City, Property_name)
    print('New iteration')
    print(Year, 'year')
    ...
    if (dropdowns[0] is None or len(dropdowns[0]) == 0 or dropdowns[0][0] == "All years") and \
            (dropdowns[1]is None or len(dropdowns[1]) == 0 or dropdowns[1][0] == "All countries") and \
            (Agency is None or len(Agency) == 0 or Agency[0] == "All agency") and \
            (City is None or len(City) == 0)and \
            (Property_name is None or len(Property_name) == 0):
        ...
        #         (Year is None or len(Year) == 0 or Year[0] == "All years")and \
        #         (Country is None or len(Country) == 0 or Country[0] == "All countries")and \
        #         (Agency is None or len(Agency or Agency == "All agency") == 0):
        #     return all_deals_query_df[(all_deals_query_df['City'].isin(City)) &
        #                               (all_deals_query_df['Property Name'].isin(Property_name))].to_dict('records')
        #
        # if (Agency == Agency) and \
        ...
        #         (Property_name == Property_name) and \
        #         (City == City) and \
        #         (Agency is None or len(Agency) == 0 or Agency == "All agency"):
        #     return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
        #                               (all_deals_query_df['Property Name'].isin(Property_name)) &
        #                               (all_deals_query_df['Country'].isin(Country)) &
        #                               (all_deals_query_df['City'].isin(City))].to_dict('records')
        ...
        #         (Agency == Agency) and \
        #         (City == City) and \
        #         (Country is None or len(Country) == 0 or Country == "All countries"):
        #     return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
        #                               (all_deals_query_df['Agency'].isin(Agency)) &
        #                               (all_deals_query_df['Country'].isin(Country)) &
        #                               (all_deals_query_df['City'].isin(City))].to_dict('records')
        ...
        #         (Agency == Agency) and \
        #         (City == City) and \
        #         (Year is None or len(Year) == 0 or Year == "All years"):
        #     return all_deals_query_df[(all_deals_query_df['Country'].isin(Country)) &
        #                               (all_deals_query_df['Agency'].isin(Agency)) &
        #                               (all_deals_query_df['Property Name'].isin(Property_name)) &
        #                               (all_deals_query_df['City'].isin(City))].to_dict('records')
