...
def update_datatable(Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal,
    ...
    cond = dict(Year=[Year], Country=[Country], Agency=[Agency],
                ...
                Type_of_Deal=[Type_of_Deal], Type_of_Consultancy=[Type_of_Consultancy], LLR_TR=[LLR_TR], Quarter=[Quarter])
    #print('New iteration')
    #print(all_deals_query_df["Type_of_Consultancy"].unique())
    list_of_values = (
    Year, Country, Agency, City, Property_name, Class, SQM, Company, Business_Sector, Type_of_Deal, Type_of_Consultancy,LLR_TR,
    Quarter)
    cond_1 = cond.copy()
    #print(cond_1.values())
...
def update_download_link(Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal, LLR_TR,
    ...
    #print(Year)
    list_of_values = (
    Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal, Type_of_Consultancy,LLR_TR, Quarter,
    Company)
    cond_1 = cond.copy()
    #print(cond_1)
    #print(cond_1.values())
...
def update_graph_tab(Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal,
    ...
    list_of_values = (Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal, Type_of_Consultancy, LLR_TR, Quarter, Company)
    cond_1 = cond.copy()
    print(cond_1.values())
    list_of_values_copy = list(filter(None, list_of_values))
