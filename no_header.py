...
with conn:
    ...
    all_deals_query_df.columns = ['Agency', 'Country', 'City', 'Property_name', 'Class', 'SQM', "Company",
                                  "Business_Sector",
                                  'Type_of_Deal', 'Type_of_Consultancy', 'LLR/TR', 'Year', 'Quarter']
...
def update_datatable(Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal,
    ...
    list_of_values = (
    Year, Country, Agency, City, Property_name, Class, SQM, Company, Business_Sector, Type_of_Deal, Type_of_Consultancy,
    Quarter)
    cond_1 = cond.copy()
    #print(cond_1.values())
...
def update_graph_tab(Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal,
    ...
    list_of_values = (
        Year, Country, Agency, City, Property_name, Class, SQM, Business_Sector, Type_of_Deal, Type_of_Consultancy, Quarter, Company
    )
    cond_1 = cond.copy()
    print(cond_1)
    print(cond_1.values())
    ...
    try:
        if list_of_values_copy[0] == "All years" or len(list_of_values_copy) == 0:
            df_plot = deals_df.copy()
            print(list_of_values_copy[0])
            print(len(list_of_values_copy) )
        else:
            df_plot = deals_df[deals_df['Year'].isin(Year)]
    except TypeError:
