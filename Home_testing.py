...
with conn:
    ...
    all_deals_query_df.columns = ['Agency', 'Country', 'City', 'Property_name', 'Class', 'SQM', "Company",
...
list_of_columns = ["Include_in_Market_Share", "Agency", "Country", "City", "Property_Name", "Address",
                   ...
                   "Type_of_deal", "Type_of_Consultancy", "LLR/TR", "LLR_Only", "(E)TR_Only",
...
def update_datatable(Year, Country, Agency, City, Property_name, Class, SQM, Type_of_Consultancy, Quarter, Company):
...
def update_sum(Year, Country, Agency, City, Property_name, Class, SQM, Type_of_Consultancy, Quarter, Company):
    cond = dict(Year=[Year], Country=[Country], Agency=[Agency],
                City=[City], Property_name=[Property_name], Class=[Class],
                SQM=[SQM], Company=[Company], Type_of_Consultancy=[Type_of_Consultancy], Quarter=[Quarter])
    print('New iteration')
    ...
    if len(list_of_values_copy) == 0 or Year[0] == 'All years':
        print(list_of_values_copy, 'первое условие')
        ...
        return 'Суммарная площадь составляет ', sqm_sum, ' кв.м'
...
def update_download_link(Year, Country, Agency, City, Property_name, Class, SQM, Type_of_Consultancy, Quarter, Company):
