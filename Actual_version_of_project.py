                            ...
                            [
                                ...
                                html.Div([dcc.Dropdown(
                                    ...
                                    options=[{
                                        ...
                                        for i in all_deals_query_df["Property Name"].unique()
                                    ],
...
def update_datatable(Year, Country, Agency, City, Property_name, Class, SQM):
    print('New iteration')
    print(Year, 'year')
    ...
    if (City == City) and \
            ...
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['City'].isin(City))].to_dict('records')

    if (Property_name == Property_name) and \
            (Year is None or len(Year) == 0 or Year[0] == "All years") and \
            (Country is None or len(Country) == 0 or Country[0] == "All countries") and \
            (Agency is None or len(Agency) == 0 or Agency[0] == "All agency") and \
            (City is None or len(City) == 0) and \
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Property Name'].isin(Property_name))].to_dict('records')
    ...
    if (Class == Class) and \
            ...
            (City is None or len(City) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Class'].isin(Class))].to_dict('records')
    ...
    if (SQM == SQM) and \
        ...
        return all_deals_query_df[(all_deals_query_df['SQM'].isin(SQM))].to_dict('records')
    ...
    if (Year == Year) and \
            (City == City) and \
            (Agency is None or len(Agency) == 0 or Agency[0] == "All agency") and \
            (Country is None or len(Country) == 0) and \
            (Property_name is None or len(Property_name) == 0) and \
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
    ...
    if (Year == Year) and \
            ...
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
                                  (all_deals_query_df['Agency'].isin(Agency))].to_dict('records')

    if (Year == Year) and \
            (Property_name == Property_name) and \
            (Country is None or len(Country) == 0 or Country[0] == "All countries") and \
            (City is None or len(City) == 0) and \
            (Agency is None or len(Agency) == 0) and \
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
    ...
    if (Year == Year) and \
            ...
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
                                  (all_deals_query_df['Class Name'].isin(Class))].to_dict('records')
    ...
    if (Country == Country) and \
            ...
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Country'].isin(Country)) &
                                  (all_deals_query_df['Agency'].isin(Agency))].to_dict('records')
    ...
    if (City == City) and \
            ...
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['City'].isin(City)) &
                                  (all_deals_query_df['Agency'].isin(Agency))].to_dict('records')
    ...
    if (City == City) and \
            ...
            (Year is None or len(Year) == 0 or Year[0] == "All years") and \
            (Country is None or len(Country) == 0 or Country[0] == "All countries") and \
            (Agency is None or len(Agency or Agency == "All agency") == 0) and \
            (Class is None or len(Class) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['City'].isin(City)) &
                                  (all_deals_query_df['Property Name'].isin(Property_name))].to_dict('records')
    ...
    if (Property_name == Property_name) and \
            ...
            (City is None or len(City) == 0) and \
            (Agency is None or len(Agency) == 0) and \
            (Country is None or len(Country) == 0 or Country[0] == "All countries" == 0):
        return all_deals_query_df[(all_deals_query_df['Property Name'].isin(Property_name)) &
                                  (all_deals_query_df['Class '].isin(Class))].to_dict('records')
    ...
    if (Class == Class) and \
            ...
            (Property_name is None or len(Property_name) == 0) and \
            (SQM is None or len(str(SQM)) == 0):
        return all_deals_query_df[(all_deals_query_df['Class'].isin(Class)) &
                                  (all_deals_query_df['SQM'].isin(SQM))].to_dict('records')
    ...
    if (City == City) and \
        ...
        return all_deals_query_df[(all_deals_query_df['City'].isin(City)) &
                                  (all_deals_query_df['Agency'].isin(Agency)) &
                                  (all_deals_query_df['Year'].isin(Year))].to_dict('records')
    ...
    if (Year == Year) and \
            ...
            (Agency == Agency) and \
            (City == City) and \
            (Country is None or len(Country) == 0 or Country == "All countries") and \
            (Class is None or len(Class) == 0):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
                                  (all_deals_query_df['Agency'].isin(Agency)) &
                                  (all_deals_query_df['Country'].isin(Country)) &
    ...
    if (Year == Year) and (Country == Country) and (Agency == Agency) and (City == City) and \
            (Property_name == Property_name and Class == Class):
        return all_deals_query_df[(all_deals_query_df['Year'].isin(Year)) &
                                  (all_deals_query_df['Agency'].isin(Agency)) &
                                  (all_deals_query_df['Country'].isin(Country)) &
                                  (all_deals_query_df['City'].isin(City)) &
